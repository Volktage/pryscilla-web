...
const noise: Noise = (() => {
    ...
    module.simplex2 = (xin: number, yin: number): number => {
        let n0, n1, n2;
        const s = (xin + yin) * F2;
    ...
    module.simplex3 = (xin: number, yin: number, zin: number): number => {
        let n0, n1, n2, n3;
    ...
    module.perlin2 = (x: number, y: number): number => {
    ...
    module.perlin3 = (x: number, y: number, z: number): number => {
        ...
        const n011 = gradP[X + 1 + perm[Y + 1 + perm[Z + 1]]].dot3(x, y - 1, z - 1);
